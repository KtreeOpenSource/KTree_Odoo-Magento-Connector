...
# Using this module we can import and export information from magneto
{
    ...
    "description": "This module is developed with the help of sources available in the lunchpad, github to enable Odoo to access the resources in magento and synchronize",
    "init_xml" : [],
    "demo_xml" : [],
    "update_xml" :  [
